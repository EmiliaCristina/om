...
const setup = () => {
  ...
  renderer.setClearColor(0xff00b7, 1);
  renderer.shadowMap.enabled = true;
  renderer.shadowMapSoft = true;

  scene.fog = new THREE.Fog(0xff7de7, 12, 950);
...
const createLights = () => {
	hemisphereLight = new THREE.HemisphereLight(0x00cbff,0xfa11cf, .2)
hemisphereLight = new THREE.HemisphereLight(0xfff,0xfa11cf, .8)
	shadowLight = new THREE.DirectionalLight(0xfa70e1, .3);
  ...
  light2 = new THREE.DirectionalLight(0xfa70e1, .3);
	light2.position.set(-600, 350, 350);

  light3 = new THREE.DirectionalLight(0xfa7080, .4);
...
const bubbleGeometry = new THREE.SphereGeometry(220, vertex, vertex );
let bubble;
const createBubble = () => {
