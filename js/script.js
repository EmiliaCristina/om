...
const setup = () => {
  ...
  renderer.setClearColor(0x49fce8, 1);
  renderer.shadowMap.enabled = true;
  renderer.shadowMapSoft = true;

  scene.fog = new THREE.Fog(0xa5aaff, 12, 950);
...
const createLights = () => {
	hemisphereLight = new THREE.HemisphereLight(0x49fce8,0xfcfc49, .2)
hemisphereLight = new THREE.HemisphereLight(0xfff,0x1aed33, .8)
	shadowLight = new THREE.DirectionalLight(0x1a5ded, .3);
  ...
  light2 = new THREE.DirectionalLight(0xfc49eb, .3);
	light2.position.set(-600, 350, 350);

  light3 = new THREE.DirectionalLight(0xe4ff00, .4);
