...
const setup = () => {
  ...
  renderer.setClearColor(0x00cbff, 1);
  renderer.shadowMap.enabled = true;
  renderer.shadowMapSoft = true;

  scene.fog = new THREE.Fog(0x00cbff, 12, 950);
...
const createLights = () => {
	hemisphereLight = new THREE.HemisphereLight(0x00cbff,0xfcfc49, .2)
hemisphereLight = new THREE.HemisphereLight(0xfff,0x00cbff, .8)
	shadowLight = new THREE.DirectionalLight(0x00cbff, .3);
  ...
  light2 = new THREE.DirectionalLight(0x00cbff, .3);
	light2.position.set(-600, 350, 350);

  light3 = new THREE.DirectionalLight(0x00cbff, .4);
